...
import GraphMaker_Test as GraphMaker
...
class NewCutUI:
    ...
    def __init__(self):
        ...
        self.window.setWindowTitle("Total Variation Segmentation")
        self.seed_type = self.graph_maker.foreground
    ...
    def on_foreground(self):
        # choose add_foreground_seeds, add seed_type=1
        self.seed_type = self.graph_maker.foreground
        self.foregroundButton.setStyleSheet("background-color: gray")
        self.backGroundButton.setStyleSheet("background-color: white")
    ...
    def on_background(self):
        # choose add_background_seeds, add seed_type=0
        self.seed_type = self.graph_maker.background
